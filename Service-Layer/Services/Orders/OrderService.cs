    ...
    public class OrderService : IOrderService
    {
        ...
        public void addOrder(OrderDto order)
        {
            ...
            try
            {
                ...
                newOrder.Attributes["initiumc_order_ssid"] = order.Id;
                newOrder.Attributes["initiumc_customerid"] = new EntityReference("initiumc_customer_ss", customerId);
                newOrder.Attributes["createdon"] = order.orderDate;
                newOrder.Attributes["initiumc_discount"] = order.discount;
        ...
        public List<OrderDto> getAllOrders()
        {
            ...
            foreach (var order in allOrders)
            {
                ...
                orderItemsList = new List<OrderItemDto>();
                ...
                var Order = new OrderDto
                {
                    ...
                    discount = order.GetAttributeValue<decimal>("initiumc_discount"),
                    orderPrice = order.GetAttributeValue<Money>("initiumc_orderprice").Value,
                    orderStatus = order.GetOptionSetValue("initiumc_orderstatus").Value,
                    customer = customer,
